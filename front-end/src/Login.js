...
// CSS is now included directly in the component to resolve the import error.
const LoginStyles = () => (
    <style>{`
        ...
        .login-form input {
          width: 100%;
          padding: 0.9rem 1rem 0.9rem 3rem; /* Adjusted padding for icon */
        ...
        <>
            ...
            <div className="login-bg">
                <div className="login-card">
                    ...
                    <p className="login-subtitle">Sign in to your ServiceSphere account</p>
